...
@click.option('--hotword-model', default='resources/snowboy.umdl',
              metavar='<snowboy hotword model file>',
              help='Path to snowboy hotword model file. ')
def main(api_endpoint, credentials, project_id,
    ...
    with SampleAssistant(lang, device_model_id, device_id,
        ...
        def listening():
            detector = snowboydecoder.HotwordDetector(hotword_model, sensitivity=0.38)
